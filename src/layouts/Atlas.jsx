            ...
            if (
                ...
                (a.medium.index !== null &&
                    (mediumsMap.get(mediumName).index === null ||
                        Number(a.medium.index) <
                            Number(mediumsMap.get(mediumName).index)))
            ) {
                ...
                item.siblings.forEach((sib) => {
                    ...
                    if (activeTerritory !== 'all') {
                        const siblingTerritory =
                            fullSibling.territory?.territory ||
                            fullSibling.territory;
        ...
        <>
            <div className='wrapper-atlas pt-header-height py-y-body px-x-body bg-[#E0E0E0] min-h-screen'>
                <div className='sticky top-[60px] lg:top-[52px] z-50'>
                    {/* --- Filters Medium --- */}
                    <fieldset className='filter-medium flex flex-wrap items-center gap-x-[10px] mb-[35px] border-0 p-0'>
                        <legend className='sr-only'>
                            {lang === 'fr'
                                ? 'Filtrer par support'
                                : 'Filter by medium'}
                        </legend>
                        {/* <span className='label capitalize'>
            ...
            <span className="label capitalize">{lang === "fr" ? "territoires :" : "territories :"}</span>
